...
Для реализации расчетов по дате оферты необходимо добавить следующие поля в таблицу облигаций:
...
**Последовательность расчетов:**
1. Дневной купон, НКД, комиссия и затраты используются те же, что и при обычном расчёте.
